  ...
  <section>
    ...
    <div class="row d-flex justify-content-center gap-5">
      <a class="d-block col-3 text-decoration-none" href="musik-dashboard.php">
        <div class="card p-2 4 justify-content-center" style="width: 15rem;">
          <div class="card-body">
            <h5 class="card-title">Musik</h5>
          </div>
        </div>
      </a>
      <a class="d-block col-3 text-decoration-none" href="artis-dashboard.php">
        <div class="card p-2 4 justify-content-center" style="width: 15rem;">
          <div class="card-body">
      ...
      <a class="d-block col-3 text-decoration-none" href="kategori-dashboard.php">
        <div class="card p-2 4 justify-content-center" style="width: 15rem;">
          <div class="card-body">
